...
function User() {
  return (
    <div className="user-container">
      <h1>This is you, Utsha. Hello!</h1>
      <h2>
        You are a 22-year-old college student. You love to watch movies and play football.
        You have two family members, Jahnavi and Aadith. Your favorite color is green.
      </h2>
